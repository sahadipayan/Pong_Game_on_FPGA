...
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports pixel_clk]
...
##Buttons
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports start_pong]; #btnC
